...
![images](img/Ashikhmin-Shirley02)
下面是原始论文里面的不同的nu,nv值的效果：
![images](img/Ashikhmin-Shirley03)
当nu=nv时，A.S模型就退化成了各向同性的模型，下面是原始论文里面的效果比较：

![images](img/Ashikhmin-Shirley04)

![images](img/Ashikhmin-Shirley05)
注意Diffuse项现在是和视点相关的，Fresnel的加入使得在不同的角度，Diffuse和Specular的比例有所区别，Fresnel采用的是Schlick的简化函数：

![images](img/Ashikhmin-Shirley06)
加入Fresnel的效果，看下面这张原始论文的图就很直观了：
![images](img/Ashikhmin-Shirley07)
下面是我的代码实现与论文中的现象相同 
Nu= 10；Nv= 10；            Nu = 10 ； Nv= 100        Nu = 10 ； Nv= 1000          Nu = 10 ； Nv= 10000

![images](img/Ashikhmin-Shirley08)
![images](img/Ashikhmin-Shirley09)
![images](img/Ashikhmin-Shirley10)
![images](img/Ashikhmin-Shirley11)
![images](img/Ashikhmin-Shirley12)
![images](img/Ashikhmin-Shirley13)
![images](img/Ashikhmin-Shirley14)
